        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'the-conference' ), $name ) ; ?></p>
...
if( ! function_exists( 'the_conference_restore_admin_notice' ) ) :
/**
 * Restoring admin notice on theme switch
 */
function the_conference_restore_admin_notice(){
    update_option( 'the_conference_admin_notice', false );
}
endif;
add_action( 'after_switch_theme', 'the_conference_restore_admin_notice' );
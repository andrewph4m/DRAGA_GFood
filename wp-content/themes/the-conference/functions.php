...
if( ! defined( 'THE_CONFERENCE_THEME_VERSION' ) ) define ( 'THE_CONFERENCE_THEME_VERSION', $theme_data->get( 'Version' ) );
if( ! defined( 'THE_CONFERENCE_THEME_NAME' ) ) define( 'THE_CONFERENCE_THEME_NAME', $theme_data->get( 'Name' ) );
